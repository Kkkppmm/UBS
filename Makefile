...
$(BUILD)/usbforge-builder: host/builder.c $(COMMON_OBJ) common/usbforge.h ui/builder/index.html ui/builder/app.js ui/builder/styles.css
	$(CC) $(CFLAGS) $(GTK_CFLAGS) $(WEBKIT_CFLAGS) host/builder.c $(COMMON_OBJ) -o $@ $(GTK_LIBS) $(WEBKIT_LIBS) $(LDFLAGS)

$(BUILD)/usbforge-live: live/live.c $(COMMON_OBJ) common/usbforge.h common/uf_theme.h
	$(CC) $(CFLAGS) $(GTK_CFLAGS) live/live.c $(COMMON_OBJ) -o $@ $(GTK_LIBS) $(LDFLAGS)

smoke: all
	$(BUILD)/usbforge-live --smoke
	$(BUILD)/usbforge-builder --smoke
